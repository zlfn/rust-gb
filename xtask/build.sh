...
rustc --emit=llvm-ir -C opt-level=3 -C embed-bitcode=no --target avr-unknown-gnu-atmega328\
	...
	-Z unstable-options ./source/src/main.rs -o ./out/main.ll

echo "Rust -> LLVM-IR completed"

./ext/llvm-project/llvm/build/bin/llvm-cbe --cbe-declare-locals-late ./out/main.ll -o ./out/main.c

echo "LLVM-IR -> C completed"
...
sdcc -S -Iinc -Isrc -Itests \
	...
	-D__PORT_sm83 -D__TARGET_gb \
    ./out/main.c -o ./out/main.asm

echo "C -> SM83 ASM completed"

./ext/bin/lcc -o ./out/main.gb ./out/main.asm

echo "ROM building completed"

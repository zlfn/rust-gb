...
use super::{
    scope, switch_bank, switch_run, switch_run_far, Anchor, Bank, BankNumber, BankSafe, Group,
    GroupZero,
};
...
impl<T: ?Sized> DynFar<T> {
    ...
    #[doc(hidden)]
    #[inline(always)]
    pub const unsafe fn new(ptr: *const T, bank: BankNumber) -> Self {
        DynFar { ptr, bank }
    }
}
...
#[inline(never)]
fn dyn_invoke_far<C: Group, R>(bank: BankNumber, f: impl FnOnce() -> R) -> R {
